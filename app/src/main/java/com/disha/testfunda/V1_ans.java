...
public class V1_ans extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v1_ans);
...
//        section=i.getStringExtra("section");
        ...
        adapter=new ExpandableListViewAdapter(V1_ans.this,listDataheader,listHashMap);
        expandable.setAdapter(adapter);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent i=new Intent(V1_ans.this,v_score1.class);
                startActivity(i);
            }
        });
    }
