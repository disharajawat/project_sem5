...
public class V1_skippedAns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v1_skipped_ans);
        ...
        skippedQuestion=i.getStringArrayListExtra("skipQ");
        ...
        adapter=new ExpandableListViewAdapter(V1_skippedAns.this,listDataheader,listHashMap);
        expandable.setAdapter(adapter);


        Log.e("size",String.valueOf(skippedQuestion.size()));

        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(j<=(skippedQuestion.size()-1)) {
                    Log.e("as", String.valueOf(j));
                    Log.e("qa",skippedQuestion.get(j).toString());
                    getCorrect();
                }
                else
                {
            ...
            @Override
            public void onClick(View v) {
                Intent i=new Intent(V1_skippedAns.this,v_score1.class);
                startActivity(i);
            }
        });
    }
    ...
    public void getCorrect()
    {
        ...
        AndroidNetworking.get("http://testfunda.000webhostapp.com/v1_ans.php")
                .addQueryParameter("question",skippedQuestion.get(j).toString())
                ...
                .getAsJSONArray(new JSONArrayRequestListener() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            Log.e("added",skippedQuestion.get(j).toString());
                            if(j<skippedQuestion.size())
                            {
