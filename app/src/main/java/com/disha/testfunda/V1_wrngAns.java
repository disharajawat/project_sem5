...
public class V1_wrngAns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v1_wrng_ans);
        ...
        incorrectQuestion = i.getStringArrayListExtra("wrngQ");
        ...
        adapter = new ExpandableListViewAdapter(V1_wrngAns.this, listDataheader, listHashMap);
        expandable.setAdapter(adapter);


        Log.e("size", String.valueOf(incorrectQuestion.size()));

        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (j <= (incorrectQuestion.size() - 1)) {
                    Log.e("as", String.valueOf(j));
                    Log.e("qa", incorrectQuestion.get(j).toString());
                    getCorrect();
                } else {
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(V1_wrngAns.this, v_score1.class);
                startActivity(i);
            }
        });
        ...
        public void getCorrect()
        {
            ...
            AndroidNetworking.get("http://testfunda.000webhostapp.com/v1_ans.php")
                    .addQueryParameter("question",incorrectQuestion.get(j).toString())
                    ...
                    .getAsJSONArray(new JSONArrayRequestListener() {
                        ...
                        public void onResponse(JSONArray response) {
                            try {
                                Log.e("added",incorrectQuestion.get(j).toString());
                                if(j<incorrectQuestion.size())
                                {
