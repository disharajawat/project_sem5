...
public class d_corrAns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d_corr_ans);
...
//        section=i.getStringExtra("section");
        ...
        adapter=new ExpandableListViewAdapter(d_corrAns.this,listDataheader,listHashMap);
        expandable.setAdapter(adapter);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent i=new Intent(d_corrAns.this,v_score1.class);
                startActivity(i);
            }
        });
    }
