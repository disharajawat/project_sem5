...
public class d_set1 extends AppCompatActivity {
    ...
    List<d_set1.Question> list= new ArrayList<>();
    List<d_set1.Ans> ansList=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d_set1);
        ...
        time_finish=new AlertDialog.Builder(d_set1.this)
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(j<7)
                {
                    ...
                    if(my_ans!="")
                    {
                        d_set1.Ans answer=new d_set1.Ans(my_ans);
                        ansList.add(answer);
                        ans1[j]=my_ans;
                        Log.e("myans",j+"-"+ans1[j]);
                        getQuestion();
                    ...
                    Toast.makeText(d_set1.this,"Score is"+score,Toast.LENGTH_LONG).show();
                    ctimer.start();
                }
                else
                {
...
//                    my_ans=choice4.getText().toString();
    ...
    public void getQuestion()
    {
        ...
        AndroidNetworking.get("http://testfunda.000webhostapp.com/logic.php")
                .setTag("test")
                        ...
                        try {
                            if(j<6){
                                for(int i=0;i<6;i++){
                                    ...
                                    d_set1.Question question = new d_set1.Question(obj.getString("question"),obj.getString("ans"),obj.getString("title"),obj.getString("choice1"),obj.getString("choice2"),obj.getString("choice3"),obj.getString("choice4"),obj.getString("explanation"));
                                    list.add(question);
                                }
                                d_set1.Question quest = list.get(j);
                            ...
                            else
                            {
                                ...
                                builder=new AlertDialog.Builder(d_set1.this)
                                        .setTitle("Test Over")
                                        .setMessage("Click OK to view your score")
                                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i=new Intent(d_set1.this,v_score1.class);
