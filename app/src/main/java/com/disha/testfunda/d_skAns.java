...
public class d_skAns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d_sk_ans);
        ...
        adapter=new ExpandableListViewAdapter(d_skAns.this,listDataheader,listHashMap);
        expandable.setAdapter(adapter);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent i=new Intent(d_skAns.this,v_score1.class);
                startActivity(i);
            }
        });
    }
