...
public class d_wrngAns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d_wrng_ans);
...
//        section=i.getStringExtra("section");
        ...
        adapter = new ExpandableListViewAdapter(d_wrngAns.this, listDataheader, listHashMap);
        expandable.setAdapter(adapter);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(d_wrngAns.this, v_score1.class);
                startActivity(i);
            }
        });
    ...
    public void getCorrect()
    {
        ...
        AndroidNetworking.get("http://testfunda.000webhostapp.com/l1_ans.php")
