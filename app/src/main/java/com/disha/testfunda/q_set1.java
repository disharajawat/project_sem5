...
public class q_set1 extends AppCompatActivity {
    ...
    List<q_set1.Question> list= new ArrayList<>();
    List<q_set1.Ans> ansList=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q_set1);
        ...
        time_finish=new AlertDialog.Builder(q_set1.this)
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(j<7)
                {
                    ...
                    if(my_ans!="")
                    {
                        q_set1.Ans answer=new q_set1.Ans(my_ans);
                        ansList.add(answer);
                        ans1[j]=my_ans;
                        Log.e("myans",j+"-"+ans1[j]);
                        getQuestion();
                    ...
                    Toast.makeText(q_set1.this,"Score is"+score,Toast.LENGTH_LONG).show();
                    ctimer.start();
                }
                else
                {
...
//                    my_ans=choice4.getText().toString();
    ...
    public void getQuestion()
    {
        ...
        AndroidNetworking.get("http://testfunda.000webhostapp.com/quant1.php")
                .setTag("test")
                        ...
                        try {
                            if(j<6){
                                for(int i=0;i<6;i++){
                                    ...
                                    q_set1.Question question = new q_set1.Question(obj.getString("question"),obj.getString("ans"),obj.getString("title"),obj.getString("choice1"),obj.getString("choice2"),obj.getString("choice3"),obj.getString("choice4"),obj.getString("explanation"));
                                    list.add(question);
                                }
                                q_set1.Question quest = list.get(j);
                            ...
                            else
                            {
                                ...
                                builder=new AlertDialog.Builder(q_set1.this)
                                        .setTitle("Test Over")
                                        .setMessage("Click OK to view your score")
                                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i=new Intent(q_set1.this,v_score1.class);
