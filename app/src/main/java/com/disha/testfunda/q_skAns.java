...
public class q_skAns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q_sk_ans);
        ...
        adapter=new ExpandableListViewAdapter(q_skAns.this,listDataheader,listHashMap);
        expandable.setAdapter(adapter);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent i=new Intent(q_skAns.this,v_score1.class);
                startActivity(i);
            }
        });
    }
