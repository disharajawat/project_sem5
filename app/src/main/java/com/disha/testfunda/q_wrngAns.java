...
public class q_wrngAns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q_wrng_ans);
        ...
        adapter = new ExpandableListViewAdapter(q_wrngAns.this, listDataheader, listHashMap);
        expandable.setAdapter(adapter);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(q_wrngAns.this, v_score1.class);
                startActivity(i);
            }
        });
